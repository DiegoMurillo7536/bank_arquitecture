...
class IndexIu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Button(self, text="Gestionar Usuarios", bg="#FAD7A0", fg="#333333",
                  command=lambda: controller.show_frame(UserUI), **button_style).pack(pady=5)
